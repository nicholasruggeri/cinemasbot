        ...
        switch(user_command) {
            case '/start':
                qs = {
                    ...
                    chat_id: chat_id,
                    text: "Hello " + req.body.message.chat.first_name + ", use '/getcinema' followed by the name of your town to receive the list of movie theaters near you.  Use /help for list of commands. If you found @CinemasBot useful, buy us a beer! http://tinyurl.com/beer-for-bot"
                };
